...
A CSMA/CA replacement should be able to provide advantages in terms of throughput, support Quality of Service (QoS) mechanisms featuring in CSMA/CA and handle many contenders without sacrificing short-term throughput fairness. Furthermore, to support the existing user base and ease its implementation on real hardware, the new MAC protocol should be backwards compatible.
