\section{Results}\label{results}
	...
	\begin{figure}[tb]
		...
		\caption{Average time between successful transmissions in non-saturated conditions: averaging over all stations. \textcolor{red}{this figure needs new data files}}
	...
	\begin{figure}[tb]
		...
		\caption{Average throughput per MAC protocol in a saturated mixed network}
