...
%	\end{figure}
	...
	\textcolor{red}{This increase in collisions may also cause the dropping of packets due to reaching the maximum retransmission limit. As CSMA/ECA$_{\text{Hys+FS}}$ sends more packets during the same simulation time, it shows a higher fraction of dropped packets in Figure~\ref{fig:unsatResults}d.}
