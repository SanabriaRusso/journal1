...
GNUTERM = "x11"
plot "../../new_raws/DCF-sat.txt" u 1:($11*100):(1.96*($12*100)/3.16) title "CSMA/CA saturated" w yerrorbars ls 1 lw 2, "" u 1:($11*100) notitle w l ls 1 lw 2, "../../new_raws/ECA-sat.txt" u 1:($11*100):(1.96*($12*100)/3.16) title "CSMA/ECA_{Hys+FS} saturated" w yerrorbars ls 3 lw 2, "" u 1:($11*100) notitle w l ls 3 lw 2
#    EOF
