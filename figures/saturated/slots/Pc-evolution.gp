...
set xrange [ 0.00000 : 80000.0 ] noreverse nowriteback
...
GNUTERM = "aqua"
plot "DCF-70stas.txt" u 2:5:(1.96*$6/3.16) title "CSMA/CA" w yerrorbars ls 1 lw 3, "ECA-70stas.txt" u 2:5:(1.96*$6/3.16) title "CSMA/ECA_{Hys+FS}" w yerrorbars ls 3 lw 3
#    EOF
