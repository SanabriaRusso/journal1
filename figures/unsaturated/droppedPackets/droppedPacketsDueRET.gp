...
set ytics 0.00000,0.0001,0.000800000 norangelimit
...
set yrange [ * : 0.000800000 ] noreverse nowriteback
...
GNUTERM = "aqua"
plot "../../new_raws/DCF-unsat.txt" u 1:($21)/($21+$23+$25):(1.96*$22/3.16)/($21+$23+$25) title "CSMA/CA non-saturated" w yerrorbars ls 1 lw 2, "" u 1:($21)/($21+$23+$25) notitle w l ls 1 lw 2, "../../new_raws/ECA-unsat.txt" u 1:($21)/($21+$23+$25):(1.96*$22/3.16)/($21+$23+$25) title "CSMA/ECA_{Hys+FS} non-saturated" w yerrorbars ls 3 lw 2, "" u 1:($21)/($21+$23+$25) notitle w l ls 3 lw 2
#    EOF
