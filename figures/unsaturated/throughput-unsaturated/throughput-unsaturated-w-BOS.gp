...
set ytics 0.00000,20,80.0000 norangelimit
...
set yrange [ -20.4000 : 85.0000 ] noreverse nowriteback
...
GNUTERM = "x11"
plot "../../new_raws/DCF-unsat.txt" u 1:($2/1e6):(1.96*($3/1e6)/3.16) title "CSMA/CA non-saturated" w yerrorbars ls 1 lw 2, "" u 1:($2/1e6) notitle w l ls 1 lw 2, "" u 1:9:(1.96*$10/3.16) title "CSMA/CA: average backoff stage" w yerrorbars ls 163 lw 2 axis x1y2, "../../new_raws/ECA-unsat.txt" u 1:($2/1e6):(1.96*($3/1e6)/3.16) title "CSMA/ECA_{Hys+FS} non-saturated" w yerrorbars ls 3 lw 2, "" u 1:($2/1e6) notitle w l ls 3 lw 2, "" u 1:9:(1.96*$10/3.16) title "CSMA/ECA_{Hys+FS}: average backoff stage" w yerrorbars ls 156 lw 2 axis x1y2
#    EOF
