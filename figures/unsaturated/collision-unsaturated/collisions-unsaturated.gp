...
set yrange [ 0.00000 : 40.0000 ] noreverse nowriteback
...
GNUTERM = "x11"
plot "../../new_raws/DCF-unsat.txt" u 1:($11*100):(1.96*($12*100)/3.16) title "CSMA/CA non-saturated" w yerrorbars ls 1 lw 2, "" u 1:($11*100) notitle w l ls 1 lw 2, "../../new_raws/ECA-unsat.txt" u 1:($11*100):(1.96*($12*100)/3.16) title "CSMA/ECA_{Hys+FS} non-saturated" w yerrorbars ls 3 lw 2, "" u 1:($11*100) notitle w l ls 3 lw 2
#    EOF
