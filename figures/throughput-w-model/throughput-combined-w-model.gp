...
set yrange [ * : 95.0000 ] noreverse nowriteback
...
GNUTERM = "aqua"
plot "../new_raws/Basic-ECA-sat.txt" u 1:($2/1e6):(1.96*($3/1e6)/3.16) title "CSMA/ECA" w yerrorbars ls 3 lw 2, "" u 1:($2/1e6) notitle w l ls 3 lw 2, "../new_raws/ECA-sat.txt" u 1:($2/1e6):(1.96*($3/1e6)/3.16) title "CSMA/ECA_{Hys+FS}" w yerrorbars ls 9 lw 2, "" u 1:($2/1e6) notitle w l ls 9 lw 2, "../code/throughputModel.txt" u 1:($2/1e6) title "Lower-bound (Hys+FS)" w l ls 10 lw 2, "" u 1:($6/1e6) title "Maximum Aggregation (Hys+MaxAg)" w l ls 12 lw 2, "" u 1:($4/1e6) title "Upperbound (Hys+FS)" w l ls 7 lw 2
#    EOF
