...
set xtics 2.00000,4,50.0000 norangelimit
...
set y2tics 0.00000,1,1.00000 norangelimit
...
set yrange [ 10.6000 : 35.0000 ] noreverse nowriteback
set y2range [ -1.00000 : 10.0000 ] noreverse nowriteback
set zlabel "" 
...
GNUTERM = "aqua"
plot "../new_raws/Basic-ECA-sat.txt" u 1:($2/1e6):(1.96*($3/1e6)/3.16) title "CSMA/ECA" w yerrorbars ls 1 lw 2, "" u 1:($2/1e6) notitle w l ls 1 lw 2, "" u 1:4:(1.96*$5/3.16) title "JFI for CSMA/ECA" w yerrorbars ls 10 lw 4 axes x1y2, "" u 1:4 notitle w l ls 10 lw 4 axes x1y2, "../new_raws/DCF-sat.txt" u 1:($2/1e6):(1.96*($3/1e6)/3.16) title "CSMA/CA" w yerrorbars ls 3 lw 2, "" u 1:($2/1e6) notitle w l ls 3 lw 2, "" u 1:4:(1.96*$5/3.16) title "JFI for CSMA/CA" w yerrorbars ls 12 lw 4 axes x1y2, "" u 1:4 notitle w l ls 12 lw 4 axes x1y2
#    EOF
